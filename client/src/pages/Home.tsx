...
import { Building2, Shield, Smartphone, Home as HomeIcon, TrendingUp, FileCheck, Users, ArrowRight } from "lucide-react";
      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 text-center text-white max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/services">
              <Button size="lg" variant="outline" className="bg-white/10 backdrop-blur-md border-white/30 text-white hover:bg-white/20 px-8">
                Explore Services
              </Button>
            </Link>
          </div>
